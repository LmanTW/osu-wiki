...
*也看看: [osu! 檔案格式](/wiki/Client/File_formats)*

![osu! 安裝資料夾在 Windows 與 macOS 上的結構](img/file_structure.jpg "[osu! 安裝資料夾在 Windows 與 macOS 上的結構")

osu! 程式檔案是一組用於運行 osu! 與追蹤用戶遊玩時不同活動的檔案。

## 安裝路徑

osu! 在預設的情況下會被安裝在以下的位置：
